...
const useValidation = (callback: Function) => {
    const validate = (username: string, password: string, confirmPassword: string, view: string): boolean => {
        let isValid = false;
        ...
        if (view === 'Signup') {
            ...
            if (!username || !password || !confirmPassword) {
                ...
                callback('Password must be at least 6 characters, symbol, upper and lower case letters and a number.');
